...
st.divider()
st.caption(
    "Model: two-stage LightGBM hurdle with conformal-calibrated quantiles. "
    "Trained on Elexon BM data and Open-Meteo forecast-vintage weather, "
    "April 2023 to March 2026. "
    "Boundary features excluded (NESO constraint limits not downloaded). "
    "Weather vintage approximated from D-1 06:00 UTC NWP model run."
)